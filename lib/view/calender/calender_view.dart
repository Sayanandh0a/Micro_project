...
class _CalenderViewState extends State<CalenderView> {
  ...
  List subArr = [
    {"name": "Electricity", "icon": "assets/img/ele.png", "price": "660"},
    {
      "name": "Petrol",
      "icon": "assets/img/pet.png",
      "price": "4000"
    },
    {
      "name": "Gas",
    ...
    {"name": "Wifi", "icon": "assets/img/wifi.png", "price": "600"},
    {
      "name": "Water",
    ...
    {"name": "Grocery", "icon": "assets/img/grocery.png", "price": "1200"}
  ];
